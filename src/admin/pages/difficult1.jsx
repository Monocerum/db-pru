...
function Difficult1() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5020/difficult1")
      .then((response) => {
            ...
            <div className="db-container">
              ...
              <div className="db">
                <table className="table database-table">
                  <thead>
                    <tr>
                    <th id="id-header">Beneficiary Designation</th>
                      <th id="id-header">Average Gross Annual Income</th>
                    </tr>
                  </thead>
                  <tbody>
                    {entry.filter((e) => {
                    ...
                    .map((e, key) => (
                      <tr key={key}>
                        <td className="data-container">{e.BeneficiaryDesignation}</td>
                        <td className="data-container">{e.AverageGrossAnnualIncome}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
