...
function Difficult3() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5020/difficult3")
      .then((response) => {
                ...
                <table className="table database-table">
                  <thead>
                    ...
                    <th id="id-header">Employer or Business Name</th>
                      <th id="id-header">Beneficiary Type</th>
                      <th id="id-header">Total Number of Beneficiaries</th>
                    </tr>
                  </thead>
                  <tbody>
                    {entry.filter((e) => {
                    ...
                    .map((e, key) => (
                      <tr key={key}>
                        ...
                        <td className="data-container">{e.TotalNumberofBeneficiaries}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
